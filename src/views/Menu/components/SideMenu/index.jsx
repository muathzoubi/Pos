  ...
  menu.menus.forEach((element) => {
    ...
    if (element.menu !== lastMenu) {
      lists.push(
        <li
          key={element.menu}
          className="font-semibold text-lg text-red-700 px-10 py-5"
        >
          {element.menu}
        </li>
      );
    ...
    if (element.sub_menu !== lastSubMenu) {
      lists.push(
        <Link key={element.id} to={`/${element.sub_menu}`}>
          <li className="font-medium text-md text-gray-700 px-10 py-3 hover:bg-red-200 hover:text-red-700">
            {element.sub_menu}
          </li>
        </Link>
      );
    ...
    show = (
      <>
        <Link to="/">
          <li
            key="0"
            className="font-semibold text-md text-gray-700 px-10 py-3 hover:bg-red-200 hover:text-red-700"
          >
            All
          </li>
        </Link>
